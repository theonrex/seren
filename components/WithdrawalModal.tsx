...
import { Ed25519PublicKey } from "@mysten/sui/dist/cjs/keypairs/ed25519";
...
export default function WithdrawModal() {
  ...
  return (
    <div>
      <div
        className="glass-panel icon-box cursor-pointer hover:bg-opacity-80 transition-all"
        onClick={() => setOpenModal(true)}
      >
        <FaArrowUp /> <span> Withdraw </span>
      </div>
