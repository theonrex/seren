...
export function isExtension(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V29}::kiosk_extension::Extension`; }
...
export function isExtensionKey(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V29}::kiosk_extension::ExtensionKey` + '<'); }
